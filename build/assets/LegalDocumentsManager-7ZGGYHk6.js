import{j as e}from"./radix-vendor-BV-zUPZ_.js";import{a as n}from"./react-vendor-BK8AH302.js";import{bR as o,aP as l,b4 as h,bH as p,aR as g}from"./ui-vendor-DgaPPGCl.js";const f={id:"terms",title:"Terms & Conditions",content:`# ShiftMyHome Terms & Conditions
...
By using our services, you agree to these terms and conditions.`,lastUpdated:new Date().toISOString(),version:"1.0"},y={id:"privacy",title:"Privacy Policy",content:`# Privacy Policy
...
**ICO Registration:** [Registration Number]`,lastUpdated:new Date().toISOString(),version:"1.0"},b={id:"driver-contract",title:"Driver Partner Agreement",content:`# DRIVER PARTNER AGREEMENT
...
*This is a legally binding agreement. Please read carefully and seek independent legal advice if needed.*`,lastUpdated:new Date().toISOString(),version:"1.0"};function w(){const[r,d]=n.useState([f,y,b]),[a,s]=n.useState(null),[c,i]=n.useState(!1),m=()=>{a&&(d(r.map(t=>t.id===a.id?{...a,lastUpdated:new Date().toISOString()}:t)),i(!0),alert("✅ Document saved successfully!"))},u=()=>{alert("✅ All legal documents published to website!"),i(!1)};return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-3xl font-bold text-slate-900",children:"Legal Documents Manager"}),e.jsx("p",{className:"text-slate-600 mt-1",children:"Manage Terms & Conditions, Privacy Policy, and other legal pages"})]}),c&&e.jsxs("button",{onClick:u,className:"flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg hover:shadow-lg transition-all",children:[e.jsx(o,{className:"w-4 h-4"}),"Publish Changes"]})]}),a?e.jsxs("div",{className:"bg-white rounded-2xl shadow-lg border border-slate-200",children:[e.jsx("div",{className:"p-6 border-b border-slate-200",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-xl font-bold text-slate-900",children:a.title}),e.jsxs("div",{className:"flex items-center gap-4 mt-2 text-sm text-slate-600",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(l,{className:"w-4 h-4"}),"Last updated: ",new Date(a.lastUpdated).toLocaleDateString("en-GB")]}),e.jsxs("div",{children:["Version: ",a.version]})]})]}),e.jsx("button",{onClick:()=>s(null),className:"px-4 py-2 border border-slate-300 rounded-lg hover:bg-slate-50 transition-all",children:"Back to List"})]})}),e.jsxs("div",{className:"p-6",children:[e.jsx("label",{className:"block text-sm font-semibold text-slate-700 mb-2",children:"Document Content (Markdown)"}),e.jsx("textarea",{value:a.content,onChange:t=>s({...a,content:t.target.value}),className:"w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-200 outline-none font-mono text-sm",rows:30}),e.jsx("p",{className:"text-xs text-slate-500 mt-2",children:"💡 Tip: Use Markdown formatting (# for headings, ** for bold, etc.)"})]}),e.jsxs("div",{className:"p-6 border-t border-slate-200 flex items-center justify-end gap-3",children:[e.jsxs("button",{onClick:()=>alert("🔍 Preview would open in new window"),className:"flex items-center gap-2 px-4 py-2 border border-slate-300 rounded-lg hover:bg-slate-50 transition-all",children:[e.jsx(h,{className:"w-4 h-4"}),"Preview"]}),e.jsxs("button",{onClick:m,className:"flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:shadow-lg transition-all",children:[e.jsx(o,{className:"w-4 h-4"}),"Save Document"]})]})]}):e.jsx("div",{className:"grid gap-6",children:r.map(t=>e.jsx("div",{className:"bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden",children:e.jsxs("div",{className:"p-6",children:[e.jsxs("div",{className:"flex items-start justify-between mb-4",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-xl font-bold text-slate-900 mb-2",children:t.title}),e.jsxs("div",{className:"flex items-center gap-4 text-sm text-slate-600",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(l,{className:"w-4 h-4"}),new Date(t.lastUpdated).toLocaleDateString("en-GB")]}),e.jsxs("div",{children:["Version: ",t.version]})]})]}),e.jsxs("button",{onClick:()=>s(t),className:"flex items-center gap-2 px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-lg transition-all",children:[e.jsx(p,{className:"w-4 h-4"}),"Edit"]})]}),e.jsx("div",{className:"bg-slate-50 rounded-lg p-4 border border-slate-200",children:e.jsxs("div",{className:"text-sm text-slate-700 line-clamp-4 whitespace-pre-wrap",children:[t.content.substring(0,300),"..."]})})]})},t.id))}),!a&&e.jsx("div",{className:"bg-blue-50 border border-blue-200 rounded-xl p-4",children:e.jsxs("div",{className:"flex items-start gap-3",children:[e.jsx(g,{className:"w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5"}),e.jsxs("div",{className:"text-sm text-blue-800",children:[e.jsx("strong",{children:"Important:"})," These legal documents are displayed on your website. Make sure they comply with UK law and GDPR regulations. Consider consulting a legal professional before publishing changes."]})]})})]})}export{w as LegalDocumentsManager};
