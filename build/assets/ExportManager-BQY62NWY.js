import{j as e}from"./radix-vendor-BV-zUPZ_.js";import{a as h}from"./react-vendor-BK8AH302.js";import{B as j,D as T,q as B,v as P,w as I,x as U,t as g}from"./index-BcnowT96.js";import{C as q}from"./badge-BhdGP7Z3.js";import{L as k,S as V,a as A,b as J,c as M,d as o}from"./select-BByHL1Py.js";import{bI as f,aR as D,cp as Y,cq as G,as as H,aQ as Q,bB as z}from"./ui-vendor-qxZeYYxY.js";function te({data:v=[],filename:c,title:y="Export Data"}){const[C,i]=h.useState(!1),[d,E]=h.useState("csv"),[u,S]=h.useState("all"),[w,b]=h.useState(!1),$=(t,a)=>{if(!t||t.length===0)return;const r=Object.keys(t[0]),s=[r.join(","),...t.map(n=>r.map(x=>{const m=n[x];return typeof m=="string"&&m.includes(",")?`"${m}"`:m}).join(","))].join(`
