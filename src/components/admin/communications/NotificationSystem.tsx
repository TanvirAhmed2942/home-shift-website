...
import { 
  ...
  Search, Filter, ChevronRight, DollarSign, Clock, Layout, Zap 
} from 'lucide-react';
import { 
...
export function NotificationSystem() {
  ...
  const calculateSimulatedFee = () => {
    ...
    const rule = rules.find(r => {
      if (r.maxHoursBefore === null) return simHoursBefore >= r.minHoursBefore;
      return simHoursBefore >= r.minHoursBefore && simHoursBefore < r.maxHoursBefore;
    });
